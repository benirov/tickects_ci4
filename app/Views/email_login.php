...
<div class="container">
  <main class="signup-container">
    ...
    <form class="signup-form">
      ...
      <button class="btn btn-login">Check tikects</button>
    </form>
    <p class="text-mute"> Aun no tienes tickets generados ? <a href="$">Envia una solicitud y empieza a darle seguimiento</a></p>
  </main>
